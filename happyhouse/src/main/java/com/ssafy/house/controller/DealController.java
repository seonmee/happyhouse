...
public class DealController {
	...
	public ResponseEntity<List<DealDto>> officeRentList(@PathVariable int type, @PathVariable String gunguCode, @PathVariable String dong, @PathVariable int currentPage) throws Exception {
		...
		DealDto deal = new DealDto(type,gunguCode,dong,currentPage,10);
	...
	@RequestMapping(value = {"/getTotCntOfficeRent/{type}/{gunguCode}/{dong}/{currentPage}"},method=RequestMethod.GET)
	public ResponseEntity<Integer> getTotCntOfficeRent(@PathVariable int type, @PathVariable String gunguCode, @PathVariable String dong, @PathVariable int currentPage) throws Exception {
	...
	public ResponseEntity<List<DealDto>> officeDealList(@PathVariable String gunguCode, @PathVariable String dong, @PathVariable int currentPage) throws Exception {
		...
		DealDto deal = new DealDto(0,gunguCode,dong,currentPage,10);
	...
	@RequestMapping(value = {"/getTotCntOfficeDeal/{gunguCode}/{dong}/{currentPage}"},method=RequestMethod.GET)
	public ResponseEntity<Integer> getTotCntOfficeDeal(@PathVariable String gunguCode, @PathVariable String dong, @PathVariable int currentPage) throws Exception {
	...
	@RequestMapping(value = {"/getTotCntHomeDeal/{gunguCode}/{dong}/{currentPage}"},method=RequestMethod.GET)
	public ResponseEntity<Integer> getTotCntHomeDeal(@PathVariable String gunguCode, @PathVariable String dong, @PathVariable int currentPage) throws Exception {
	...
	@RequestMapping(value = {"/getTotCntAptDeal/{gunguCode}/{dong}/{currentPage}"},method=RequestMethod.GET)
	public ResponseEntity<Integer> getTotCntAptDeal(@PathVariable String gunguCode, @PathVariable String dong, @PathVariable int currentPage) throws Exception {
