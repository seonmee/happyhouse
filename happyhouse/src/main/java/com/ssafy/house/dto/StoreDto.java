...
public class StoreDto {
	...
	public StoreDto(String sidoCode, String gugunCode, String dongCode, int curPage, int spp) {
		super();
	...
	public StoreDto(int storeId, String storeName, String branchName, String largeCategorCode, String largeCategory,
